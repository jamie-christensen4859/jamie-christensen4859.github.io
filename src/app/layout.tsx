...
export const metadata: Metadata = {
  title: 'Jamie Christensen | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Jamie Christensen! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
