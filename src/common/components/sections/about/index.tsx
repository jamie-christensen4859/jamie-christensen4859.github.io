          ...
          <div className="antialiased group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              <div className="flex h-full flex-col justify-center gap-6">
                <span>
                  Easier said than done - I will demonstrate my abilities through my work in technology.
                </span>
                <span>
                  I’m a software engineer with over 10 years of experience. 
                  I don’t believe in overselling myself—my work speaks for my skills. 
                  <br></br>While many focus on self-promotion, I value honesty, trust, and hard work—especially 
                  in remote environments where these traits matter most. I enjoy tackling new challenges, 
                  exploring new technologies, and collaborating with great teams. 
                  <br></br>My goal is to use my skills to contribute meaningfully to both people and society.
                </span>
